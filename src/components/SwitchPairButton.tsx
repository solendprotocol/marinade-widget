...
const SwitchPairButton = ({
  ...
  return (
    <div className="flex justify-center">
      <div
        onClick={onClick}
        className={`border border-black/50 fill-current text-black bg-black/10 dark:text-[#4A5568]-35 dark:hover:text-[#4A5568]/50 dark:border dark:border-white-35 dark:hover:border-white/50 h-8 w-8 rounded-full flex items-center justify-center cursor-pointer ${
