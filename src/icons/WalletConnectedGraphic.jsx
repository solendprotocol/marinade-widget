...
const WalletConnectedGraphic = ({ width = '152', height = '125' }) => {
    return (<svg width={width} height={height} viewBox="0 0 152 125" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M1.1842 8C1.1842 3.85787 4.54207 0.5 8.6842 0.5H144C148.142 0.5 151.5 3.85786 151.5 8V124.5H1.1842V8Z" stroke="white" strokeOpacity="0.25"/>
...
exports.default = WalletConnectedGraphic;
